# -*- coding: utf-8 -*-
"""cnn_layer_visulaization.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1OEo6bnico8DqgImaT51B6SYPb4aAdBhQ
"""

#Note: layer indexing is still an issue. The way resnet is built, it has only 9 layers which further has layers in it, so the index of layer should be passed accordingly
...
class CNNLayerVisualization():
    ...
    def __init__(self, model, selected_layer, selected_filter):
        ...
        #if not os.path.exists('/content/drive/My Drive/Colab Notebooks/results/new_generated'):
        #    os.makedirs('/content/drive/My Drive/Colab Notebooks/results/new_generated')
    ...
    def visualise_layer_with_hooks(self, device, opPath,is_3d=False, size = (224, 224, 3), affine_size= 4, isDepthFirst = False):
        # Hook the selected layer
    ...
    def visualise_layer_without_hooks(self, device, opPath, is_3d = False, size = (224, 224, 3), affine_size = 4, isDepthFirst = False ):
        # Process image and return variable
        # Generate a random image
        random_image = np.uint8(np.random.uniform(150, 180, size))
        # Process image and return variable
